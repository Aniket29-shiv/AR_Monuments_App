...
//        ModelRenderable newColorCopyofRenderable = crystalRenderable.makeCopy();
...
//        ModelRenderable newRenderable = render(crystalRenderable);
       ModelRenderable.builder()
                .setSource(this,R.raw.tajmahal)
    ...
    private  ModelRenderable render(ModelRenderable renderabletaj){
//        Material m = crystalRenderable.getMaterial().makeCopy();
//        ModelRenderable tajRenderable = crystalRenderable.makeCopy();
        renderabletaj.getMaterial().setFloat3(
                MaterialFactory.MATERIAL_COLOR, new com.google.ar.sceneform.rendering.Color(Color.WHITE));
        return renderabletaj;


//        m.setFloat3("baseColorTint", new Color.WHITE);
//        crystalRenderable.setMaterial(m);
    }
...
//            ModelRenderable newRenderable = render(crystalRenderable);
            ...
            addName(anchornode,crystal,"TAJ MAHAL :\n"+
